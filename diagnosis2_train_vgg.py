...
train_generator, val_generator, test_generator = get_data_generators(image_size, batch_size, 'GRY', 'diagnosis-2class', 'vgg')
...
model.save("model_vgg_diagnosis2_GRY256.h5")
